...
const BlogPost = ({ post, locale, className }: { post: BlogPostProps, locale: Locale, className?: string }) => {
  const t = useTranslations("Blog");

  return (
    <Card className={cn("py-0 h-full flex flex-col overflow-hidden rounded-2xl shadow-md hover:shadow-xl transition-shadow bg-background", className)}>
